...
class HttpClient {
    ...
    private buildUrl(
        ...
        const url = new URL(
            urlString,
            this.baseUrl ? undefined : window.location.origin
        );
        if (params) {
    ...
    async get<T>(
        ...
        try {
            ...
            throw new Error(
                `Erreur GET: ${error instanceof Error ? error.message : 'Erreur inconnue'}`
            );
        }
    }
    ...
    async post<T>(
        ...
        try {
            ...
            throw new Error(
                `Erreur POST: ${error instanceof Error ? error.message : 'Erreur inconnue'}`
            );
        }
    }
    ...
    async put<T>(
        ...
        try {
            ...
            throw new Error(
                `Erreur PUT: ${error instanceof Error ? error.message : 'Erreur inconnue'}`
            );
        }
    }
    ...
    async delete<T>(endpoint: string): Promise<T> {
        try {
            ...
            throw new Error(
                `Erreur DELETE: ${error instanceof Error ? error.message : 'Erreur inconnue'}`
            );
        }
    }
}
