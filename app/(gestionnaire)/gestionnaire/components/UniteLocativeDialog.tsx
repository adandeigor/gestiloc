...
const UniteLocativeSchema = z.object({
    ...
    description: z
        .string()
        .min(1, "La description de l'unité locative est requise"),
    prix: z
        .number()
        .min(0, "Le prix de l'unité locative doit être supérieur ou égal à 0"),
});

type UniteLocativeFormType = z.infer<typeof UniteLocativeSchema>;

export function UniteLocativeDialog({
    open,
    onClose,
    proprieteId,
    unite,
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                            Nom de l&#39;unité locative
                        </label>
                        <Input
                            {...register('nom')}
                            placeholder="Nom de l'unité locative"
