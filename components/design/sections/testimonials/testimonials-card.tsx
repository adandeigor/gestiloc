    ...
    return (
        <Card className="flex flex-col bg-gray-200 shadow-md border-none rounded-lg p-6 hover:shadow-lg duration-400 ease-in-out cursor-pointer hover:scale-105 transition-all">
            <CardContent className="flex flex-col gap-4">
                ...
                {/* Témoignage */}
                <p className="text-gray-600 montserrat-regular text-sm md:text-base">
                    {quote}
                </p>
            </CardContent>
            <CardFooter className="mt-auto">
                <div className="flex flex-row items-center justify-start gap-3">
                    ...
                    <div className="flex flex-col">
                        <span className="text-primary montserrat-bold text-sm">
                            {name}
                        </span>
                        <span className="text-gray-500 montserrat-regular text-xs">
                            {title}
                        </span>
                    </div>
                </div>
