        ...
        >
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="relative z-10  md:text-start lg:max-w-2xl">
                    <p className="mb-4 text-2xl tracking-tight font-bold md:font-extrabold text-white md:text-5xl lg:text-6xl font-sans">
                        Gérez vos biens immobiliers en toute simplicité
                    </p>
                    <p className="mb-4 text-md font-semibold text-white md:text-lg lg:text-xl font-mono">
                        GestiLoc vous offre une solution complète pour la
                        gestion de vos propriétés locatives, du suivi des
                        paiements à la communication avec vos locataires.
                    </p>
