      ...
      <div className="max-w-screen-xl mx-auto text-center  bg-white rounded-lg shadow-lg">
        <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex flex-col items-start  p-8 gap-4 max-w-xl">
                <p className="text-2xl font-bold text-start">Prêt à simplifier votre gestion locative ?</p>
                <p className="text-md font-mono text-start">Rejoignez des milliers de propriétaires qui ont déjà transformé leur façon de gérer leurs biens immobiliers.</p>
