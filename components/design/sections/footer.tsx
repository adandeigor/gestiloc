...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-primary text-white py-12" aria-label="Pied de page GestiLoc">
      <div className="container mx-auto px-6">
        
        <div className="grid grid-cols-1 md:grid-cols-4 max-w-screen-xl mx-auto gap-8 mb-12">
            <div className="flex flex-col items-center md:items-start mb-12">
                <p className='text-2xl font-bold text-white montserrat-bold'>Gestiloc</p>
                <p className="text-white text-center md:text-left montserrat-regular max-w-md">
                    La solution complète pour la gestion de vos biens immobiliers.
                </p>
          ...
          <div>
            <h3 className="text-lg font-bold text-white montserrat-bold mb-4">Liens rapides</h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-white montserrat-bold mb-4">Ressources</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="text-lg font-bold text-white montserrat-bold mb-4">Contact</h3>
